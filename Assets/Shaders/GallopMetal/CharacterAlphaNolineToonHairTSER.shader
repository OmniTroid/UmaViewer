// Metal re-authoring of Gallop/3D/Chara/AlphaNolineToonHair/TSER (URP). Same shared
// GallopMetalToon core as the other ports, but alpha-blended: this is the transparent variant
// (glasses lenses, see-through hair), so it blends by the main-texture alpha instead of clipping.
Shader "Gallop/3D/Chara/AlphaNolineToonHair/TSER"
{
    Properties
    {
