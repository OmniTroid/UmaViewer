// Metal re-authoring of Gallop/3D/Chara/AlphaNolineToon/TSER (URP). Approximation via shared GallopMetalToon core.
Shader "Gallop/3D/Chara/AlphaNolineToon/TSER"
{
    Properties
    {
