// Metal re-authoring of Gallop/3D/Chara/ToonEye/T (URP). Approximation via shared GallopMetalToon core.
Shader "Gallop/3D/Chara/ToonEye/T"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(VaryToon IN) : SV_Target { return UnlitShade(IN); }
            ENDHLSL
        }
    }
    Fallback Off
